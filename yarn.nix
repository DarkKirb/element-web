{
  ...
  packages = [
    ...
    {
      name = "_types_lodash___lodash_4.17.11.tgz";
      path = fetchurl {
        name = "_types_lodash___lodash_4.17.11.tgz";
        url = "https://registry.yarnpkg.com/@types/lodash/-/lodash-4.17.11.tgz";
        sha512 = "jzqWo/uQP/iqeGGTjhgFp2yaCrCYTauASQcpdzESNCkHjSprBJVcZP9KG9aQ0q+xcsXiKd/iuw/4dLjS3Odc7Q==";
      };
    }
    {
